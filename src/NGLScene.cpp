...
void NGLScene::initializeGL()
{
  ...
  shader->loadShader("PortalProgram","shaders/portalVert.glsl","shaders/portalFrag.glsl");
...
void NGLScene::paintGL()
{
  ...
  shader->setRegisteredUniform("N", N);
  shader->setRegisteredUniform("invV", view.inverse());
  shader->setRegisteredUniform("colour",m_Col);

//  std::unique_ptr<ngl::Obj> mesh(new ngl::Obj("myobj.obj"));
//  mesh->createVAO();
//  mesh->draw();
